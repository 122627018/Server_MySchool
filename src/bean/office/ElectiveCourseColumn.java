...
public class ElectiveCourseColumn {
	/**
	 * 
	 <td>选课课号</td> <td>课程代码</td> <td>课程名称</td> <td>课程性质</td> <td>是否选课</td> <td>
	 * 教师姓名</td> <td>学分</td> <td>周学时</td> <td>上课时间</td> <td>上课地点</td> <td>教材</td>
	 * <td>修读标记</td> <td>授课计划上传次数</td> <td>授课计划最近上传时间</td> <td>授课计划上传文件名</td>
	 * <td>授课计划下载</td
	 */
	/**
	 * 选课课号
	...
	public ElectiveCourseColumn(String number, String code, String name,
			...
			String weekTime, String classTime, String location, String teach,
			String tag, String upCount, String nearUpTime, String upName) {
		super();
		this.number = number;
		this.code = code;
		this.name = name;
